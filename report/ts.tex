...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \caption{8 most influential shapelets}
        \label{fig:shapelets}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=1\textwidth]{plotsss/top1.png}
        \caption{Most influential shapelet}
        \label{fig:top1}
    \end{minipage}
    \centering
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=1\textwidth]{plotsss/top2.png}
        \caption{Second most influential shapelet}
        \label{fig:top2}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=1\textwidth]{plotsss/top3.png}
        \caption{Third most influential shapelet}
        \label{fig:top3}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.55\textwidth}
        Figure~\ref{fig:cm_shapelets} shows the confusion matrix for
        Random Forest model based on shapelets.
