...
In addition to this analysis, SAX representation was computed
considering, again, 
the top three motifs of each time series, with a word length of 4 and
alphabet size of 3.
Figure~\ref{fig:sax_representation} shows the most common motifs.
