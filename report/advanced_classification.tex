...
% For the \texttt{titleType} task, the results showed a clear trend:
% models capable of capturing nonlinear relationships significantly
% outperformed linear approaches. 
% Logistic Regression achieved an accuracy of approximately 0.75,
% providing a reasonable baseline but struggling with the complex, 
% multi-modal structure of the feature space.
% Support Vector Machines with an RBF kernel improved performance substantially, 
