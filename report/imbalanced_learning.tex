...
which were 
\begin{center}
  \texttt{`high': 0.6659, `low': 9.7015, `medium': 0.7167}.  
...
Thus, we were satisfied with the results of \texttt{SMOTE} and \texttt{ADASYN} as they provided a good balance between accuracy and recall.
