...
the average rating (on a 1--10 scale) assigned by IMDb users to each
...
The optimized Random Forest was first evaluated on the test set.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{plotsss/rf_top18_actual_vs_predicted.png} 
\caption{Actual vs Predicted \texttt{averageRating} for the Random Forest model}
...
Figure~\ref{fig:nn_actual_vs_predicted} shows the scatter
plot of actual vs predicted ratings.
The model's Mean Absolute Error (MAE) was 0.78, its Mean Squared Error
(MSE) was 1.15.
...
\begin{figure}[H]
    ...
    % \begin{minipage}{0.55\textwidth}
        % \centering
        \includegraphics[width=0.55\textwidth]{plotsss/preds_reg_nn.png}
