...
In the \textit{Agglomerative hierarchical clustering} results, the dendrogram 
...
For \textit{KMeans}, both the elbow method and the silhouette score suggested that $k=6$ was the most suitable choice, 
...
the average gross at the release day ($t=0$), at the midpoint of the observation window 
($t=50$), and at the final day ($t=99$) was reported in order to summarize the typical 
temporal evolution of movies belonging to each cluster.

The results highlight substantial heterogeneity across clusters, both in terms of revenue scale and temporal dynamics.
The largest cluster (Cluster 3, 953 movies) is characterized by extremely high 
opening-day revenues, with an average gross exceeding $10^7$ USD at release, 
followed by a sharp decline over time. 
%This pattern is typical of blockbuster movies, where 
A large fraction of total revenue is concentrated in the initial days after release.

Clusters 4 and 0 (88 and 87 movies, respectively) exhibit intermediate behaviors. 
Cluster 4 shows relatively high opening-day revenues (on the order of $10^6$ USD) 
followed by a gradual decay, whereas Cluster 0 is characterized by lower initial values 
and a pronounced peak around the midpoint of the observation window, suggesting a more 
gradual build-up of audience interest.
...
with very low opening revenues and a sharp increase toward the end of the time 
horizon, indicative of outlier behavior.